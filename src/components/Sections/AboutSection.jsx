...
import { JOURNEY_STEPS, PASSIONS } from "../../utile/data";
                ...
                >
                  ...
                  <div
                    className={`flex-grow p-6 rounded-xl border transition-all duration-300 ${
                      isDarkMode
                        ? "bg-gray-800/50 border-gray-700 group-hover:bg-gray-700"
                        : "bg-white/80 border-gray-200 group-hover:bg-gray-100"
                    } backdrop-blur-sm`}
                  >
