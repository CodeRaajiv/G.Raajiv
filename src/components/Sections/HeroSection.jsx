...
const HeroSection = () => {
  ...
  return (
    ...
    >
          ...
          <div className="hidden lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
                ...
                <motion.a
                  ...
                  className={`border ${
                    isDarkMode
                      ? "border-gray-700 hover:border-gray-600 text-gray-300"
                      : "border-gray-300 hover:border-gray-400 text-gray-700"
                  } px-8 py-4 rounded-full text-sm uppercase tracking-wider font-medium transition-all duration-300 bg-blue-800 text-neutral-200`}
                >
                  Download Resume
                </motion.a>
              </motion.div>
            ...
            >
              <div className="relative">
                <motion.div
                  variants={itemVariants}
                  className="flex items-center space-x-8 text-xs uppercase tracking-widest absolute -top-16 -left-16"
                >
      ...
      <motion.div
        variants={itemVariants}
        className="flex justify-center items-center space-x-6 text-xs tracking-widest flex-wrap mb-8 lg:hidden"
      >
        <span className={isDarkMode ? "text-gray-600" : "text-gray-500"}>Mongo DB</span>
        <span className={isDarkMode ? "text-gray-600" : "text-gray-500"}>Express.js</span>
